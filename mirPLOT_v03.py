...
You have differnt modes to run mirPLOT.py
 ...
 1- With Bam files of shortRNA reads mapped against miRNA precursors+some flanking nucleotides:
   ...
   1.1 - Providing precursors fasta file and bam files directory
	 ...
	 $ python mirPLOT_v03.py --BamFilesDir Example_Files/ --PrecsFasta Example_Files/conserved+30.fa --output Figures_2  --Flanking_bases 11

   1.2 - Providing precursors fasta file, bam files directory and gff3 file with mature miRNA annotations

	 $ python mirPLOT_v03.py --BamFilesDir Example_Files/ --PrecsFasta Example_Files/conserved+30.fa --output Figures_2  --gff3Matures Example_Files/Coordinates_matures_30.gff3 --Flanking_bases 11

   1.3 - Providing precursors fasta file, bam files directory and gff3 file with mature and star miRNA annotations
	 
	 $ python mirPLOT_v03.py --BamFilesDir Example_Files/ --PrecsFasta Example_Files/conserved+30.fa --output Figures_2  --gff3Matures Example_Files/Coordinates_matures_30.gff3  --gff3Stars Example_Files/Coordinates_stars_30.gff3 --Flanking_bases 11


 2- With Bam files of shortRNA reads mapped against genome and  gff3 files
	 $ python mirPLOT_v03.py --BamFilesDir  --Genome --output Figures_2  --gff3Matures  --gff3Stars --gff3Precs --Flanking_bases 11
...
if  ( "gff3Matures" in globals() and  "gff3Stars" in globals() ): # Mature and star gff3
	...
	if "Genome" not in globals():
		...
		print "\nGENOME!!!\n"
		os.system("Rscript scripts/Visualization_genome.R "+BamFilesDir+" "+Genome+" "+output_dir+"plots"+" "+gff3Matures+" "+gff3Stars+" "+gff3Precs)
		...
		with open(fastaref, 'r') as inF:
			for line in inF:
				if ">" in line:
					...
					pictname=output_dir+"/"+precursorname.split(">")[1]+'.png'
