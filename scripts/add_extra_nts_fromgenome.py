...
with open(filenames, 'r') as inF:
	...
	for line2 in inF:
		if "miRNA" in line2:
			...
			pr_i=splitted[3]
			pr_e=splitted[4]
			pr_i_new=int(pr_i)-extrents
			pr_e_new=int(pr_e)+extrents
			...
			print splitted[0]+"\t"+splitted[1]+"\t"+splitted[2]+"\t"+str(pr_i_new)+"\t"+str(pr_e_new)+"\t"+splitted[5]+"\t"+splitted[6]+"\t"+splitted[7]+"\t"+splitted[8]
